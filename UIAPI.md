...
Best way to start writing a new plugin, is by cloning the [Skeleton plugin repository](https://github.com/zend-server-plugins/Skeleton), which is stored on GitHub as well. You may find our [first UI plugin](https://github.com/zend-server-plugins/zs_web_api_client) as an additional useful reference. Most of the examples in this documentation are taken from there.
